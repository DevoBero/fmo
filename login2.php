...
<header role="banner">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand absolute" href="index.html">FMO-tweets</a>
          ...
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item"  href="login.php?user=<?php echo $username; ?>">LOG IN AS USERS</a>
                  <a class="dropdown-item" href="index2.php?user=<?php echo $username; ?>">VIEW YOUR DASHBOARD</a><br>
                </div>
              </li>
            <li class="nav-item">
      ...
      <div class="container">
        <div class="row justify-content-center ">
          <div class="col-sm-7 box bg-info">
            <h1 class="mb-3 text-white">Log in as a New Organisation or an Existing Organisation
                 </h1>
		   ...
		   <div class="dropdown">
                ...
                <a class="text-white" href="index2.php?user=<?php echo $username; ?>">VIEW YOUR DASHBOARD</a><br>
		   </div>
  ...
  <form method="post" action="login2.php">
  	...
  	<div class="input-group">
  		<button type="submit" class="btn" name="login_user2">Login</button>
  	</div>
  	<p>
