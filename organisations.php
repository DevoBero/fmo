        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            ...
            <ul class="navbar-nav absolute-right">
              ...
              <li class="nav-item">
                <a href="register2.php" class="nav-link">Register</a>
              </li>
            </ul>
          ...
          <div class="col-md-12">
            ...
            <div class="mb-5 element-animate">
              <div class="row align-items-center">
                <div class="col-md-8">
                  <h2 class=" lead mb-0 text-white">REGISTER YOUR ORGANISATION</h2>
                  <p>Powered by FofxAcademy</p>
                  <p class="mb-8">View users Feedbacks and drop a message to acknowledge comments</p>
                  
                  <p><a href="register2.php" class="btn btn-primary mr-2">Sign Up Now</a> <a href="users.html" class="btn btn-outline-white">Visit Users Page</a></p>
                </div>
                <div class="col-md-4">
                  <img src="images/FMO_tweet12.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
            </div>            
          </div>
        ...
        <div class="row top-course">
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              ...
              <h2 class="text-white">Web Design 101</h2>
              <p>Enroll Now</p>
            </a>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              ...
              <h2 class="text-white">Learn How To Develop WordPress Plugin</h2>
              <p>Enroll Now</p>
            </a>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              ...
              <h2 class="text-white">JavaScript 101</h2>
              <p>Enroll Now</p>
            </a>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              ...
              <h2 class="text-white">Photoshop Design 101</h2>
              <p>Enroll Now</p>
            </a>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              ...
              <h2 class="text-white">Learn Native ReactJS</h2>
              <p>Enroll Now</p>
            </a>
          </div>
          <div class="col-lg-2 col-md-4 col-sm-6 col-12">
            <a href="#" class="course">
              ...
              <h2 class="text-white">Learn AngularJS 2</h2>
              <p>Enroll Now</p>
            </a>
          </div>
        </div>
