  ...
  <body>
    <header role="banner">
      <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand absolute" href="index.php">FMO-tweets</a>
    ...
    <!-- END header -->
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/hero_image2.jpg);">
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <div class="mb-5 element-animate">
              <div class="row align-items-center">
                <div class="col-md-8">
                  <h2 class="lead mb-0">Drop Your Feedbacks on any Organisation</h2>
                  <p>Powered by Fofxacademy</p>
                  <p class="mb-5">Drop a feedback for any Organisation of Choice</p>
                  
                  <p><a href="register.php" class="btn btn-primary mr-2">Sign up Now</a> <a href="organisations.html" class="btn btn-outline-white">Visit Organisation Page</a></p>
                </div>
                <div class="col-md-4">
                  <img src="images/FMO_tweet7.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
            </div>
    ...
    <!-- END section -->
     ...
     <section class="site-section episodes bg-info">
      <div class="container">
        <div class="row bg-light align-items-center p-4 episode">
          ...
          <div class="col-md-9">
            ...
            <h2><a href="#">IT related Videos feedback Here coming soon!!! </a></h2>
        ...
        <div class="row align-items-center p-4 episode">
          ...
          <div class="col-md-9">
            ...
            <h2><a href="#">TV and Commercials Video feedback Here coming soon!!! </a></h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, fugit!</p>
          </div>
        </div>
        ...
        <div class="row bg-light align-items-center p-4 episode">
          ...
          <div class="col-md-9">
            ...
            <h2><a href="#">Agriculture Videos feedback Here coming soon!!! </a></h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, fugit!</p>
          </div>
        </div>
        ...
        <div class="row align-items-center p-4 episode">
          ...
          <div class="col-md-9">
            ...
            <h2><a href="#">Banking feedbacks in videos Here coming soon!!! </a></h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, fugit!</p>
          </div>
        </div>
        ...
        <div class="row bg-light align-items-center p-4 episode">
          ...
          <div class="col-md-9">
            ...
            <h2><a href="#">Oil Stream Video feedback Here coming soon!!! </a></h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, fugit!</p>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center text-white">
            <i><h2>Information Technology</h2></i>
            <p class="lead">You May Also Like toDrop your comments on the following Programming Languages</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2>Join the Registered IT experts </h2>
            <p class="lead">Feedback improves efficiency and enhances Prefection.</p>
          </div>
        </div>
    ...
    <section class="section-cover bg-info">
      <div class="container">
        <div class="row justify-content-center align-items-center intro">
          <div class="col-md-7 text-center element-animate">
            <h2>Sign Up and Join the Conversations</h2>
            <p class="lead mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto quidem tempore expedita facere facilis, dolores!</p>
            <p><a href="#" class="btn btn-primary">Organisations awaits your Feedbacks</a></p>
          </div>
        </div>
      </div>
    </section>
