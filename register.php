      ...
      <div class="container">
        <div class="row justify-content-center ">
          <div class="col-sm-7 box bg-primary">
            <h1 class="mb-3 text-white">Log in as a New User or <br>an Existing User
                 </h1>
		   ...
		   <div class="dropdown">
                ...
                <a class="text-white" href="index.php?user=<?php echo $username; ?>">GO TO YOUR DASHBOARD</a><br>
		   </div>
		</div>
</div>
<div class="container">
