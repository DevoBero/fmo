          ...
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item"  href="login2.php?user=<?php echo $username; ?>">LOG IN AS ORGANISATION</a>
                  <a class="dropdown-item" href="index.php?user=<?php echo $username; ?>">VIEW YOUR DASHBOARD</a><br>
                </div>
              </li>
            <li class="nav-item">
    ...
    <section class="fact-section spad set-bg" data-setbg="images/big_image_6.jpg" style="background-image: url(&quot;images/FMO_tweet6.jpg&quot;);">
      <div class="container">
        <div class="row justify-content-center ">
          <div class="col-sm-7 box bg-info">
            <h2 class="mb-3 text-white">Log in as a New User or an Existing user
                 </h2>
                 <div class="header-right">
				
				
				<a class="text-white" href="login2.php?user=<?php echo $username; ?>">LOG IN AS ORGANISATION</a>

				<a class="text-dark" href="Tweets.php?user=<?php echo $username; ?>">TWEETS</a>

		   		<a class="text-white" href="users.php?user=<?php echo $businessname; ?>">VIEW-USERS</a>
		   ...
		   <div class="dropdown">
                ...
                <a class="text-white" href="index.php?user=<?php echo $username; ?>">VIEW YOUR DASHBOARD</a><br>
		   </div>
		   <h2>Log in as Users</h2>
		</div>
</div>
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-7 order-lg-3 order-1 mb-lg-0 mb-5" >
              ...
              <div class="col-lg-4 order-lg-1 order-2 mb-lg-0 mb-5">
                ...
                <p class="text-black">&mdash; Ben David, UI/UX designer Certified ReactJS Student</p>
              </div>
            </div>
          </div>
    </section>
